...
{{ Form::model($edition, ['route' => ['edition.update', $edition->id], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'novalidate']) }}
        ...
        <div class="x_content">
            ...
            <div class="item form-group {{ $errors->has('season_type_id') ? 'has-error' : '' }}">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    {{ Form::select('season_types', $season_types, $edition->season_type_id) }}
