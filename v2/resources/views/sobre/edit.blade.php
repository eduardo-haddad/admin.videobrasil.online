...
{{ Form::model($sobre, ['route' => ['sobre.update', $sobre->id], 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'novalidate']) }}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="item form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Conteúdo <span class="required">*</span></label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                    {{ Form::textarea('content_pt', null, ['class' => 'form-control']) }}
