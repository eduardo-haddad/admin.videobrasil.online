...
{{ Form::model($role, ['route' => ['partnerroles.update', $role->id], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'novalidate']) }}
      ...
      <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="item form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Chancela <span class="required">*</span></label>
