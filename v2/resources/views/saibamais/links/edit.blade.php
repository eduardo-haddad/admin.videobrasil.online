...
{{ Form::model($linksaibamais, ['route' => ['linksaibamais.update', $linksaibamais->id], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'novalidate']) }}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
            ...
            {{ Form::hidden('saibamais_id', $linksaibamais->saibamais_id) }}
