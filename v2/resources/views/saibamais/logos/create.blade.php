...
{{ Form::open(['route' => ['logosaibamais.store', $saibamais_id], 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'novalidate']) }}
        ...
        <div class="x_content">
            ...
            <div class="item form-group {{ $errors->has('partner_roles_id') ? 'has-error' : '' }}">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    {{ Form::select('partner_roles', $partner_roles, null) }}
